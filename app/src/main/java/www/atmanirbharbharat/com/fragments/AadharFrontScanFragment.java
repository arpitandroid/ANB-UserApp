...
public class AadharFrontScanFragment extends Fragment implements View.OnClickListener {
    ...
    private String adhaarFrontImageUrl;
    ViewGroup viewGroup;
    boolean next = false;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        adhaarFrontImageUrl = sharedPreferences.getString(SharedPref.ADHAR_FRONT_URL, "@null");
    }
    ...
    private void init(ViewGroup viewGroup) {
        uploadAdhaarFront = viewGroup.findViewById(R.id.uploadAdhaarFront);
        nextButton = viewGroup.findViewById(R.id.nextButton);
        progressbar = viewGroup.findViewById(R.id.progressbar);
        imageFrontAdhaar = viewGroup.findViewById(R.id.imageFrontAdhaar);
    ...
    private void uploadPdfApiHit(Uri uri) {
        ...
        if (NetworkInfo.hasConnection(getActivity())) {
            ...
            final MultipartBody.Part body = MultipartBody.Part.createFormData("adhar_card_front", "adhar_card_front.pdf", requestFile);
            RequestBody token = RequestBody.create(MediaType.parse("multipart/form-data"), tokenLogin);

            Call<AdhaarCardFrontModel> call = apiService.uploadAdhaarFrontImage(token, body);
    ...
    private void uploadImageApiHit(byte[] imageBytes) {
        if (NetworkInfo.hasConnection(getActivity())) {
            ...
            final MultipartBody.Part body = MultipartBody.Part.createFormData("adhar_card_front", "adhar_card_front.jpeg", requestFile);
            RequestBody token = RequestBody.create(MediaType.parse("multipart/form-data"), tokenLogin);
